!(function () {
  ...
  var r = "stub",
    ...
    g = function (e) {
      return (function (e) {
        ...
        return function () {
          ...
          var i = n[0],
            ...
            l = n[3],
            d = void 0 === l ? s : l;
          if (Number(d) === Number(s) && "string" == typeof i)
            switch (i) {
              case "ping":
                return (
                  u.updateData({ cmpStatus: r, supportedAPIs: o }),
                  u.getPingData(d)
                );
      ...
      })({ store: e, cmpId: v(), supportedAPIs: [s, u] });
    },
    y = function (e) {
      return (function (e) {
        var t = e.store,
        ...
        return function () {
          ...
          if (
            ...
            switch (a) {
              ...
              case "addEventListener":
                var d = ++t.lastId;
                t.events.push({ id: d, callback: i, version: l });
                var f = {
        ...
        if (!n)
          if (t.body) {
            ...
            (r.style.cssText = "display:none"),
              ...
              r.setAttribute("title", "GPP Locator"),
              (r.name = a),
        ...
        function (e) {
          ...
          a &&
            window.__gpp(
              ...
              function (n, r) {
                var i = {
                  __gppReturn: { returnValue: n, success: r, callId: a.callId },
                };
                e &&
                  e.source &&
                  e.source.postMessage &&
                  e.source.postMessage(t ? JSON.stringify(i) : i, "*");
              },
              a.parameter,
              a.version
            );
          ...
          null !==
            (e =
              null !== (r = i) && void 0 !== r
                ...
                : null === (a = window._iub) ||
                  void 0 === a ||
                  null === (a = a.csConfiguration) ||
                  void 0 === a
                ? void 0
                : a.gppVersion) && void 0 !== e
            ? e
            : f()),
        1 === Number(i)
