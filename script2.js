      ...
      spin: function (e) {
        ...
        if (
          ...
          var l,
            ...
            u = r.fps,
            c = u / r.speed,
            p = (1 - r.opacity) / ((c * r.trail) / 100),
            f = c / r.lines;
          !(function h() {
            s++;
            for (var e = 0; e < r.lines; e++)
              (l = Math.max(1 - ((s + (r.lines - e) * f) % c) * p, r.opacity)),
...
(_iub.badges = _iub.badges || []),
  ...
  (function initEmbeddings(B, L, I) {
    function t() {
      var e = s("iubenda-embed", L);
      if (e.length)
        for (var t = 0; t < e.length; t++) {
          var n = e[t],
            i = { ppId: D(n.getAttribute("href")), isLegal: d(n) };
          -1 !== P(n.className.split(" "), "iub-body-embed")
            ? b({ linkA: n, embedB: !0 }) ||
              ((i.index = Math.floor(1e10 * Math.random())),
              (i.linkA = a(n, i, i.index)),
              I.embedBs.push(i))
            : b({ linkA: n }) || ((i.linkA = a(n, i)), I.badges.push(i));
        }
      else {
        var r = L.getElementById("iubenda-embed");
        r && a(r);
      }
    }
    function a(t, e, n) {
      ...
      if (
        ...
        S(v, t, {
          ...
          a || j(t, f),
          (i = t);
      } else i = T(t, c, null, null, f, r, y, v, w, a, l, s, h, b, m);
      return (
    ...
    function j() {}
    function T(e, t, n, i, r, a, o, l, s, d, u, c, p, f, h) {
      ...
      var E = "width:" + v + "px; height:" + x + "px;";
      c && (E += " z-index:9998; position:fixed; bottom:0px; right:0px;"),
        O(N, E),
      ...
      var k = null,
        B = N.contentWindow || N,
        I = N.contentDocument || B.document;
      I.open(),
        I.write(
          '<a href="' +
            C +
      ...
      return (
        ...
        (S.src = l),
        (S.onload = function () {
          var e = { useProtocol: g, zIndex: f, overflow: h, cdnBaseUrl: y };
          k && (e.iFrUrl = k), N.contentWindow._iub.ifr.iubendaStartBadge(e);
        }),
        (S.onerror = function () {
          console.log(
    ...
    function M(e, t, n, i, r, a, o) {
      ...
      if (((s = U(s, l)), (a.url = s), "undefined" != typeof IubSpinner)) {
        ...
        (d.el.className = "_iub-pp-loading-alert"),
          O(d.el, "position:relative; display:inline-block; padding: 6px;"),
          e.parentNode.insertBefore(d.el, e);
      }
      return (e.style.display = "none"), S(s, e, { tries: 1 }), e;
    }
    function u(e) {
    ...
    function e(e) {
      try {
        var t = b({ url: e.path, embedB: !0, inDom: !0 });
        if (t && t.linkA) {
          var n = t.linkA,
          ...
          var r = null === e.path.match(/embed-no-markup\.json$/);
          if (e.css && r) {
          ...
          if (e.js) {
            ...
            (o.innerHTML = e.js),
              L.getElementsByTagName("head")[0].appendChild(o);
          }
          if (e.js_urls)
            for (
              var l = Array.isArray(e.js_urls) ? e.js_urls : [],
                s = 0,
                d = l.length;
              s < d;
              s += 1
          ...
          "_iub-pp-loading-alert" === u.className &&
    ...
    function f(e) {
      ...
      function n(e) {
        var t = e.text || e.textContent || e.innerHTML || "",
          n = L.getElementsByTagName("head")[0] || L.documentElement,
      ...
      for (var c = 0; l[c]; c++)
        !t((r = l[c]), "script") ||
          ...
          a.push(r);
      for (var p = 0; a[p]; p++)
        (i = a[p]).parentNode && i.parentNode.removeChild(i), n(a[p]);
    }
    function O(e, t) {
      var n = l();
    ...
    function o(e, t, n, i, r, a) {
      if (!(n <= 0 || a)) {
        var o = L.getElementById(e),
          l = L.createElement("img");
        (l.src = t),
          (l.style.width = i + "px"),
          (l.style.height = r + "px"),
          (l.style.border = "0px"),
    ...
    function S(e, t, n) {
      ...
      s.setAttribute("type", "text/javascript"),
        ...
        (s.onerror = function d() {
          0 < l && S(h(r, "t", l), a, { onLoadCallB: o, tries: l - 1 });
        });
    }
    function c(e, t) {
      var n = l();
    ...
    function s(e, t) {
      for (
        var n = t || L.getElementsByTagName("body")[0],
          i = [],
          r = new RegExp("\\b" + e + "\\b"),
    ...
    function b(e) {
      for (
        ...
        if (t.linkA && n[r].linkA === t.linkA) {
          if (!i || L.body.contains(n[r].linkA)) return n[r];
        } else if (
          t.url &&
          -1 < n[r].url.indexOf(t.url) &&
          (!i || L.body.contains(n[r].linkA))
        )
          return n[r];
      return null;
    }
    ...
    function H(e, t) {
      ...
      return t && (i -= 18), L.body.removeChild(n), i;
    }
    function V(e) {
    ...
    var n = "1.6.5",
      ...
      G =
        "https://www.iubenda.com/assets/privacy_policy-1c21f5c01bd94b7d3bc1e706ab549e7607e1fa348c28a45c19e5089bdb615f29.css";
    !(function i() {
      try {
        t();
      } catch (e) {
      ...
      (I.setStyle = O),
      (I.onLoadCall = c),
      (I.imageFastReplace = o),
      (I.getElementsByClassName = s),
      (I.loadPPContent = e),
      (I.VERSION = n);
